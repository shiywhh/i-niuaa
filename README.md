...
- 课表导出：AppBar 分享按钮，导出 .ics 日历文件（文件名=学年学期，
  WakeUp 格式：周次段拆 RRULE、提前 20 分钟提醒）或唤起系统分享
- 节次时间：内置将军路/明故宫/天目湖三校区作息预设
  （三四节"错峰浮动"按校区钉死口径），可手动改每节时刻，
  课表时间栏直接显示
...
- 关于：版本信息、检查更新（对比 GitHub Releases）、仓库链接、开源许可
